...
#
# issues_url 'https://github.com/<insert_org_here>/pull-essentials-windows-repo/issues'

# The `source_url` points to the development reposiory for this cookbook.  A
# `View Source` link will be displayed on this cookbook's page when uploaded to
# a Supermarket.
#
# source_url 'https://github.com/<insert_org_here>/pull-essentials-windows-repo'
